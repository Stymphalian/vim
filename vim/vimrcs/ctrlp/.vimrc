...
let g:ctrlp_lazy_update = 25  "only update preview after 250 ms
...
let g:ctrlp_brief_prompt=1     "exit ctrl-p with backspace
...
nmap <leader>mj :CtrlP<cr>
nmap <leader>m :CtrlPBuffer<cr>
nmap <leader>mk :CtrlPMixed<cr>
nmap <leader>ml :CtrlPMRU<cr>
